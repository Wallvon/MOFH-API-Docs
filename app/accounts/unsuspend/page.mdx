...
description: Unsuspends a vPanel user account
---

import { Callout, Tabs, Cards, Table } from "nextra/components";
import { XCircle, Key, CornerDownLeft, PauseCircle } from "react-feather";
...
<XmlOnly>
  ...
  <code>
    ```console copy filename="URL"
    https://panel.myownfreehost.net/xml-api/unsuspendacct.php
    ```
  </code>
</XmlOnly>
...
<Cards.Card
  icon={<CornerDownLeft />}
  title="Hosting account callbacks: account reactivation"
  href="/callbacks/hostingAccount#account-reactivation"
/>
