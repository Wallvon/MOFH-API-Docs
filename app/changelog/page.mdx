---
title: Changelog
description: List of changes made to the API docs
---
...
- Merge domain endpoints into new format
- Update index to include iFastNet support link
- Update initial setup page

## 2026-04-26

- Merge ticket endpoints into new format
- Update README

## 2026-04-25

- Merge account endpoints into new format
- Fix minor inconsistencies
- Add related pages to callback pages

## 2026-04-21

- Overhaul authentication, callbacks and error pages
- Merge information pages
- Add related pages

## 2026-04-20

- Finish API version switcher
- Start working on merging JSON and XML docs
- Update errors page

## 2026-04-19

- Get started working on API version switcher

## 2026-04-18

- Upgrade Next to release 16.x
- Upgrade Nextra to release 4.x
- Add GET/POST indications
- Update home page
- Create [limitations](/limitations) page
- Create [API wrappers](/apiWrappers) page
- Fix changelog entry date (whoops)
- Add sidebar separator
- Fix footer
- Change next up link on home page
- Update [add allowed IP](/initialSetup/addAllowedIp) page
- Add [initial setup](/initialSetup) page
