...
<Callout emoji="ℹ️" type="info">
  **When is the SQL Cluster callback sent?** The SQL Cluster callback is
  generally sent a few seconds after an account has been activated for the first
  time.
</Callout>
...
<Callout emoji="ℹ️" type="info">
  **When does an account get auto-deleted?** An account usually gets deleted
...
<Callout emoji="ℹ️" type="info">
  **Important Note:** The callback URL that you entered in the MOFH panel above
  is the same URL that the ticket callback system uses.
</Callout>
